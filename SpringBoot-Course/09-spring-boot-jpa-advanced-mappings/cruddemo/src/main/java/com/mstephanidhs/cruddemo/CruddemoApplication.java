package com.mstephanidhs.cruddemo;

import com.mstephanidhs.cruddemo.dao.AppDAO;
import com.mstephanidhs.cruddemo.entity.*;
...
public class CruddemoApplication {
	...
	private void createCourseAndReviews(AppDAO appDAO) {
		...
		// add some reviews
		tempCourse.adddReview(new Review("Great course ... loved it!"));
		tempCourse.adddReview(new Review("Cool course, job well done."));
		tempCourse.adddReview(new Review("What a dumb course, you are an idiot!"));
